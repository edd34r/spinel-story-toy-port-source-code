	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'happyspinel':	
				...
				var bgGardenNew:BGSprite = new BGSprite('sky', -500, -100, 0.1, 0.1);
				add(bgGardenNew);
								
				var place:BGSprite = new BGSprite('place', -300, -5, 1.0, 1.0);
				place.setGraphicSize(Std.int(place.width * 0.95));
				place.updateHitbox();
				add(place);
				
				var pillars:BGSprite = new BGSprite('pillars', -443, -1, 1.7, 1.7);
				pillars.setGraphicSize(Std.int(place.width * 1.4));
				add(pillars);

			case 'kvikshohol':
				
				var bgGardenDead:BGSprite = new BGSprite('sky2', -500, -100, 0.1, 0.1);
				add(bgGardenDead);

				var place:BGSprite = new BGSprite('place_but_old', -300, -5, 1.0, 1.0);
				place.setGraphicSize(Std.int(place.width * 0.95));
				place.updateHitbox();
				add(place);
			...
			case 'hoholstiki':
				...
				var bg:BGSprite = new BGSprite('skyblue', -1890, -2160, 1.0, 1.0);
				bg.setGraphicSize(Std.int(bg.width * 1.50));
				bg.updateHitbox();
				add(bg);
				
				var bg:BGSprite = new BGSprite('skyshader', -1890, -2160, 1.0, 1.0);
				bg.setGraphicSize(Std.int(bg.width * 1.50));
				bg.updateHitbox();
				add(bg);
				
				var glow:BGSprite = new BGSprite('glow', -1890, -2160, 1.0, 1.0);
				glow.setGraphicSize(Std.int(glow.width * 1.50));
				glow.updateHitbox();
				add(glow);	
								
				var place:BGSprite = new BGSprite('place_but_injector', -1890, -2160, 1.0, 1.0);
