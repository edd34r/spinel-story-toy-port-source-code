...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		lightPINKBG.frames = Paths.getSparrowAtlas('lightMenu','heart');
		...
		spinelTitle.frames = Paths.getSparrowAtlas('spinel_in_the_menu','heart');
		...
		logoBl.frames = Paths.getSparrowAtlas('spinelLOGOBUMP','heart');
